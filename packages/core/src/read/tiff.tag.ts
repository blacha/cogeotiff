...
// export interface CogTiffTagBase {
//     id: number;
//     name: string;
//     type: number;
...
// export interface CogTiffTagInline<T> extends CogTiffTagBase {
//     tag: 'inline';
//     value: T;
// }

// export interface CogTiffTagLazy<T> extends CogTiffTagBase {
//     tag: 'lazy';
//     value: T | null;
//     fetch(): Promise<T>;
// }

// export interface CogTiffTagOffset extends CogTiffTagBase {
//     tag: 'offset';
//     value: number[] | null;
//     fetch(): Promise<number[]>;
// }

// export type CogTiffTag<T = unknown> = CogTiffTagInline<T> | CogTiffTagLazy<T> | CogTiffTagOffset;

// export interface CogTiffTag<T> {
//     value: T | null;
//     id: number;
//     dataType: number;
//     dataCount: number;
...
// export class CogTiffTag {
//     view: DataView;
//     id: number;
//     constructor(id: number, view: DataView) {
//         this.id = id;
//         this.view = view;
//     }
...
// export class CogTiffTag<T = unknown> {
//     size: number;
//     name: string;
//     id: TiffTag;
//     value(): T {
...
//     constructor(id: number, tiff: CogTiff, tiffOffset: number, view: DataView) {
//         this.tiff = tiff;
//         this.byteOffset = tiffOffset;

//         this.view = view;

//         this.id = id;
//         this.name = TiffTag[this.id];
//         this.dataType = view.getUint16(2);
//         this.dataCount = getUint(view, 4, this.tiff.ifdConfig.pointer, this.tiff.isLittleEndian);
