...
import { ByteSize } from '../src/read/byte.size';
import { TiffEndian } from '../src/read/tif';
import { FakeCogSource } from './fake.source';
...
function getUint64(dataview: DataView, byteOffset: number, isLittleEndian: boolean) {
    ...
    const combined = isLittleEndian ? left + 2 ** 32 * right : 2 ** 32 * left + right;
